...
- `<leader>bd(` - удалить круглые скобки `()`
- `<leader>bd[` - удалить квадратные скобки `[]`
- `<leader>bd{` - удалить фигурные скобки `{}`
- `<leader>bd<` - удалить угловые скобки `<>`
- `<leader>bd'` - удалить одинарные кавычки `''`
- `<leader>bd"` - удалить двойные кавычки `""`
- `<leader>bd`` ` - удалить обратные кавычки `` `` ``
